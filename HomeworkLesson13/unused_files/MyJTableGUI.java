...
//		buttonGetUsers = new JButton("Get user data");
//		buttonGetUsers.setAlignmentX(Component.CENTER_ALIGNMENT);
//		buttonGetUsers.setFocusable(false);
		
//		MyJTableEngine   engine   = new MyJTableEngine(this);
//		buttonGetUsers.addActionListener(engine.getButtonGetNewsAdapter());
		
//		windowContent.add(buttonGetUsers);
//		windowContent.add(Box.createRigidArea(new Dimension(0,10)));
